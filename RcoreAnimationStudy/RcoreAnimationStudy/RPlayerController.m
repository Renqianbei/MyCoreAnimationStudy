...
#import "RPlayerController.h"
#import <AVFoundation/AVFoundation.h>


@interface RPlayerController()
{
    NSInteger  videoSource;
}
...
@implementation RPlayerController
...
-(AVPlayer *)player{
    if (!_player) {
        AVPlayerItem *playerItem=[self getPlayItem:videoSource];
...
-(AVPlayerItem *)getPlayItem:(NSInteger)videoIndex{
    ...
    NSMutableArray *paths = [[NSUserDefaults standardUserDefaults] objectForKey:@"MyappRecordvideoPaths"];
    ...
    if (path) {
     ...
     fileurl = [NSURL fileURLWithPath:path];
        ...
        NSString *urlStr=[NSString stringWithFormat:@"http://ipd.pps.tv/web/play_simple.php?url_key=3GTXD2"];
