...
#import "RenImagePickerRecord.h"
#import <AVFoundation/AVFoundation.h>
#import <MobileCoreServices/MobileCoreServices.h>

@interface RenImagePickerRecord()
...
@implementation RenImagePickerRecord
#pragma mark - 控制器视图事件
- (void)viewDidLoad {
    [super viewDidLoad];
    //通过这里设置当前程序是拍照还是录制视频
...
- (void)video:(NSString *)videoPath didFinishSavingWithError:(NSError *)error contextInfo:(void *)contextInfo{
    if (error) {
        ...
        if (paths) {
            [paths addObject:videoPath];
            
        }else {
            paths = [NSMutableArray array];
            [paths addObject:videoPath];
        }
        [[NSUserDefaults standardUserDefaults] setObject:paths forKey:@"MyappRecordvideoPaths"];
